 ...
 * 
 */
@WebServiceClient(name = "CurrencyConversionWSService", targetNamespace = "http://ModuleWebServices/", wsdlLocation = "http://localhost:13797/CurrencyConvertor/CurrencyConversionWSService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CURRENCYCONVERSIONWSSERVICE_QNAME = new QName("http://ModuleWebServices/", "CurrencyConversionWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:13797/CurrencyConvertor/CurrencyConversionWSService?wsdl");
    ...
    public CurrencyConversionWS getCurrencyConversionWSPort() {
        return super.getPort(new QName("http://ModuleWebServices/", "CurrencyConversionWSPort"), CurrencyConversionWS.class);
    }
    ...
    public CurrencyConversionWS getCurrencyConversionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ModuleWebServices/", "CurrencyConversionWSPort"), CurrencyConversionWS.class, features);
    }
